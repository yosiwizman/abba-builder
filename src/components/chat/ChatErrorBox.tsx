  ...
  if (error.includes("doesn't have a free quota tier")) {
    return (
      <ChatErrorContainer onDismiss={onDismiss}>
        {error}
        <span className="ml-1">
          <ExternalLink href="https://abba-ai-builder.local/pro">
  ...
  if (
    ...
    return (
      <ChatErrorContainer onDismiss={onDismiss}>
        ...
        or read the
        <span className="ml-1">
          <ExternalLink href="https://abba-ai-builder.local/docs/help/ai-rate-limit">
    ...
    return (
      <ChatInfoContainer onDismiss={onDismiss}>
        <span>
          ...
          <ExternalLink href="https://academy.abba-ai-builder.local/subscription">
            Upgrade to Dyad Max
          </ExternalLink>{" "}
